"""
Discord Voice Channel Nickname Bot with Proper Slash Commands
...
# Slash Commands - Define outside the class for proper registration
...
# Function to add all commands to the bot tree
async def setup_commands(bot):
    """Add all slash commands to the bot tree."""
